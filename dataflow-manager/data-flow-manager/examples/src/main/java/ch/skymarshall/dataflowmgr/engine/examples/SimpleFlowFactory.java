...
ActionPoint<IntTransfer, ?> dumpIntTransfer = ActionPoint.terminal(UUID.fromString("6c072b83-e71f-4307-8a0d-86724e014bd6"), new DumpIntTransfer());
		...
		final OutputDecisionRule<IntTransfer, IntTransfer> intTransferIdentity_out_8a3152fb_4d16_4ff7_92a4_bce11cc30987 = OutputDecisionRule.output(UUID.fromString("8a3152fb-4d16-4ff7-92a4-bce11cc30987"), (apOut) -> true, FlowActionType.CONTINUE, LocalAPRef.local(dumpIntTransfer), (apOut) ->  apOut);
