...
class SimpleFlow extends AbstractFlow {
	...
	public void execute(java.lang.String inputDataPoint) {
		...
		// simpleService_init -------------------------
		ch.skymarshall.dataflowmgr.examples.simple.dto.MyData simpleService_init = this.simpleService
				.init(inputDataPoint);
		...
		if (activated_simpleService_complete_complete) {
			String simpleExternalAdapter_getCompletionsimpleService_complete_complete = this.simpleExternalAdapter
					.getCompletion(simpleService_init);
			complete = this.simpleService.complete(simpleService_init,
					simpleExternalAdapter_getCompletionsimpleService_complete_complete);
