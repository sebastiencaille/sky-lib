...
public class GenericEditorLauncher {
    ...
    public static void main(final String[] args) {
        ...
        GenericEditorClassModel<EditedObject> model = GenericEditorClassModel.builder(EditedObject.class) //
                .addAdapters(new GenericEditorValidationAdapter()) // optionally add validation
                .build();
        final GenericEditorController<EditedObject> editor = new GenericEditorController<>(view.mainPanel(),
                model);
