	...
	public TestObjectGuiModel(final String prefix, final IScopedSupport propertySupport,
		...
		aSecondValueProperty = Properties.of(new IntProperty(prefix + "-ASecondValue", propertySupport))
				.persistent(Persisters.from(currentObjectProvider,
						GetSetAccess.<ch.skymarshall.example.gui.TestObject, java.lang.Integer>access(
								o -> o::getASecondValue, o -> o::setASecondValue)))
		...
		aFirstValueProperty = Properties
				...
				.persistent(Persisters.from(currentObjectProvider,
						GetSetAccess.<ch.skymarshall.example.gui.TestObject, java.lang.String>access(
								o -> o::getAFirstValue, o -> o::setAFirstValue)))
				.setErrorNotifier(errorProperty).getProperty();
	...
	public IComponentBinding<ch.skymarshall.example.gui.TestObject> loadBinding() {
		return new IComponentBinding<ch.skymarshall.example.gui.TestObject>() {
			...
			public void addComponentValueChangeListener(
					final IComponentLink<ch.skymarshall.example.gui.TestObject> link) {
				// nope
			}
			...
			public void setComponentValue(final AbstractProperty source,
					final ch.skymarshall.example.gui.TestObject value) {
				if (value != null) {
