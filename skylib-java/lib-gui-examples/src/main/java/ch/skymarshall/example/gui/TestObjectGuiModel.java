...
public class TestObjectGuiModel extends GuiModel implements IObjectGuiModel<TestObject> {
    ...
    public TestObjectGuiModel(final String prefix, final IScopedSupport propertySupport, final ErrorProperty errorProperty) {
		...
		aSecondValueProperty = new IntProperty(prefix + "-ASecondValue",  propertySupport).configureTyped(Configuration.persistent(currentObjectProvider, Persisters.getSet(TestObject::getASecondValue, TestObject::setASecondValue)), Configuration.errorNotifier(errorProperty));
		aFirstValueProperty = new ObjectProperty<java.lang.String>(prefix + "-AFirstValue",  propertySupport).configureTyped(Configuration.persistent(currentObjectProvider, Persisters.getSet(TestObject::getAFirstValue, TestObject::setAFirstValue)), Configuration.errorNotifier(errorProperty));
