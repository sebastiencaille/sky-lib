...
public class ControllerExampleObjectGuiModel extends GuiModel implements IObjectGuiModel<ControllerExampleObject> {
	...
	public ControllerExampleObjectGuiModel(final String prefix, final IScopedSupport propertySupport,
		...
		booleanPropProperty = new BooleanProperty(prefix + "-BooleanProp", propertySupport)
				.configureTyped(
						Configuration.persistent(currentObjectProvider,
								Persisters.getSet(ControllerExampleObject::isBooleanProp,
										ControllerExampleObject::setBooleanProp)),
						Configuration.errorNotifier(errorProperty));
		intPropProperty = new IntProperty(prefix + "-IntProp", propertySupport)
				.configureTyped(
						Configuration.persistent(currentObjectProvider,
								Persisters.getSet(ControllerExampleObject::getIntProp,
										ControllerExampleObject::setIntProp)),
						Configuration.errorNotifier(errorProperty));
		stringPropProperty = new ObjectProperty<java.lang.String>(prefix + "-StringProp", propertySupport)
				.configureTyped(
						Configuration.persistent(currentObjectProvider,
								Persisters.getSet(ControllerExampleObject::getStringProp,
										ControllerExampleObject::setStringProp)),
						Configuration.errorNotifier(errorProperty));
		testObjectPropProperty = new ObjectProperty<ch.skymarshall.example.gui.TestObject>(prefix + "-TestObjectProp",
				propertySupport)
						.configureTyped(
								Configuration.persistent(currentObjectProvider,
										Persisters.getSet(ControllerExampleObject::getTestObjectProp,
												ControllerExampleObject::setTestObjectProp)),
								Configuration.errorNotifier(errorProperty));
