...
public class ControllerExampleObjectGuiModel extends GuiModel
		implements IObjectGuiModel<ch.skymarshall.example.gui.controller.impl.ControllerExampleObject> {
	...
	public ControllerExampleObjectGuiModel(final String prefix, final IScopedSupport propertySupport,
		...
		booleanPropProperty = Properties.of(new BooleanProperty(prefix + "-BooleanProp", propertySupport))
				.persistent(Persisters.from(currentObjectProvider,
						GetSetAccess.<ch.skymarshall.example.gui.controller.impl.ControllerExampleObject, java.lang.Boolean>access(
								o -> o::isBooleanProp, o -> o::setBooleanProp)))
				.setErrorNotifier(errorProperty).getProperty();
		intPropProperty = Properties.of(new IntProperty(prefix + "-IntProp", propertySupport))
				.persistent(Persisters.from(currentObjectProvider,
						GetSetAccess.<ch.skymarshall.example.gui.controller.impl.ControllerExampleObject, java.lang.Integer>access(
								o -> o::getIntProp, o -> o::setIntProp)))
				.setErrorNotifier(errorProperty).getProperty();
		stringPropProperty = Properties
				.of(new ObjectProperty<java.lang.String>(prefix + "-StringProp", propertySupport))
				.persistent(Persisters.from(currentObjectProvider,
						GetSetAccess.<ch.skymarshall.example.gui.controller.impl.ControllerExampleObject, java.lang.String>access(
								o -> o::getStringProp, o -> o::setStringProp)))
				.setErrorNotifier(errorProperty).getProperty();
		testObjectPropProperty = Properties
				.of(new ObjectProperty<ch.skymarshall.example.gui.TestObject>(prefix + "-TestObjectProp",
						propertySupport))
				.persistent(Persisters.from(currentObjectProvider,
						GetSetAccess.<ch.skymarshall.example.gui.controller.impl.ControllerExampleObject, ch.skymarshall.example.gui.TestObject>access(
								o -> o::getTestObjectProp, o -> o::setTestObjectProp)))
				.setErrorNotifier(errorProperty).getProperty();

		allProperties = new AbstractProperty[] { booleanPropProperty, intPropProperty, stringPropProperty,
				testObjectPropProperty };
	}

	public ControllerExampleObjectGuiModel(final String prefix, final GuiController controller) {
		this(prefix, controller.getScopedChangeSupport(), GuiModel
				.createErrorProperty(prefix + "-ControllerExampleObject-Error", controller.getScopedChangeSupport()));
	}

	public ControllerExampleObjectGuiModel(final GuiController controller) {
		this("ControllerExampleObject", controller.getScopedChangeSupport(),
				GuiModel.createErrorProperty("ControllerExampleObject-Error", controller.getScopedChangeSupport()));
	}

	public ControllerExampleObjectGuiModel(final String prefix, final IScopedSupport propertySupport) {
		this(prefix, propertySupport,
				GuiModel.createErrorProperty(prefix + "-ControllerExampleObject-Error", propertySupport));
	}

	public ControllerExampleObjectGuiModel(final IScopedSupport propertySupport) {
		this("ControllerExampleObject", propertySupport,
				GuiModel.createErrorProperty("ControllerExampleObject-Error", propertySupport));
	}
	...
	public IComponentBinding<ch.skymarshall.example.gui.controller.impl.ControllerExampleObject> loadBinding() {
		return new IComponentBinding<ch.skymarshall.example.gui.controller.impl.ControllerExampleObject>() {
			...
			public void addComponentValueChangeListener(
					final IComponentLink<ch.skymarshall.example.gui.controller.impl.ControllerExampleObject> link) {
				// nope
			}
			...
			public void setComponentValue(final AbstractProperty source,
					final ch.skymarshall.example.gui.controller.impl.ControllerExampleObject value) {
				if (value != null) {
