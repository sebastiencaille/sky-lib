...
public interface Deserializers {
   ...
   List<ReferenceHandler<TestCase, ?>> TESTCASE_HANDLERS = List.of(
           TestStepMixin.ROLE_REF_HANDLER, 
           TestStepMixin.ACTOR_REF_HANDLER, 
           TestStepMixin.ACTION_REF_HANDLER,
           TestReferenceMixin.REF_HANDLER,
           TestParameterValueMixin.REF_HANDLER);
    ...
    SimpleModule TCWRITER_MODULE = new SimpleModule("TCWriter")
