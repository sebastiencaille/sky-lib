// File generated from template2022/01/12 01:16:00
...
public class GeneratedTest {
	...
	public void testCase() {
		...
		step1_var2.setISO();
		CustomerTestRole.buy(step1_var1, step1_var2);
		
		// Step 2: As delivery company, I deliver the item
		DeliveryTestRole.deliverItem();
		...
		step3_var2.setISO();
		CustomerTestRole.checkPackage(step3_var1, step3_var2);
		
		// Step 4: As customer, I resell the item for 10$
		CustomerTestRole.resellOwnedItem(10);
		...
		CustomerTestRole.buy(step5_var1, step5_var2);
