...
public class GeneratedTest {
	...
	public void testCase() {
		// Step 1: As customer, I go on internet (https://truc) and buy a coffee machine
		// of brand "OldSchool" (ISO: yes)
		ch.skymarshall.tcwriter.examples.api.interfaces.selectors.BuyingLocationSelector step1_var1 = BuyingLocationSelector
				.onInternet("https://truc");
		ch.skymarshall.tcwriter.examples.api.interfaces.dto.TestItem step1_var2 = TestItem
		...
		ch.skymarshall.tcwriter.examples.api.interfaces.selectors.PackageDeliverySelector step3_var1 = PackageDeliverySelector
				.deliveredItem();
		ch.skymarshall.tcwriter.examples.api.interfaces.dto.TestItem step3_var2 = TestItem
				.coffeeMachineOfBrand("OldSchool");
		step3_var2.setISO();
		...
		ch.skymarshall.tcwriter.examples.api.interfaces.selectors.BuyingLocationSelector step5_var1 = BuyingLocationSelector
				.inLocalShop();
		...
		ch.skymarshall.tcwriter.examples.api.interfaces.selectors.PackageDeliverySelector step6_var1 = PackageDeliverySelector
				.fromShop();
