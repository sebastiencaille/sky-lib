...
public class MyTC {
	...
	public void testCase() throws Exception {
		...
		// Step 1 - ch.skymarshall.tcwriter.generators.model.TestActor@289032f6: Buy an item/buy
		...
		// Step 2 - ch.skymarshall.tcwriter.generators.model.TestActor@289032f6: check the packaged item/check that the packaged item is
		...
		// Step 3 - ch.skymarshall.tcwriter.generators.model.TestActor@289032f6: Resell the item/resell the item
		customer.resellOwnedItem(10);
		
		testExecutionController.afterStepExecution(3);
		testExecutionController.beforeStepExecution(4);
		// Step 4 - ch.skymarshall.tcwriter.generators.model.TestActor@289032f6: Look for another brand/find another brand
		...
		// Step 5 - ch.skymarshall.tcwriter.generators.model.TestActor@289032f6: Keep a note/keep a note
