...
public class JavaToDictionary {
	...
	public static void main(final String[] args) throws IOException {
		...
		final TestDictionary dictionary = new JavaToDictionary(
				ClassFinder.forApp().withPackages(sourcePackage).withAnnotation(TCRole.class, Policy.CLASS_ONLY)
						.withAnnotation(TCActors.class, Policy.CLASS_ONLY).scan().collect(Collectors.toList()))
								.generateDictionary();
