...
import static ch.scaille.tcwriter.model.Helper.methodKey;
import static ch.scaille.tcwriter.model.Helper.paramKey;
import static ch.scaille.tcwriter.model.Helper.roleKey;
...
public class ClassToDictionaryVisitor {
	...
	private void forClassAndSuper(@Nullable final Class<?> tcClazz, final Set<Class<?>> processed,
