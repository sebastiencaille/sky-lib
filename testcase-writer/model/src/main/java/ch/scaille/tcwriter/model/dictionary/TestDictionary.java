...
public class TestDictionary {
    ...
    public static final TestDictionary NOT_SET = new TestDictionary("not set");
    ...
    public void addActor(final TestActor actor, @Nullable final TestObjectDescription actorDescription) {
    ...
    public void overrideTemplate(@Nullable String tcTemplate) {
        if (tcTemplate != null) {
