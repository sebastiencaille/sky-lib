...
import ch.scaille.tcwriter.model.Default;
...
public class TestParameterValue extends IdObject {
     ...
     * value type
     */
    protected TestParameterFactory parameterValueFactory = TestParameterFactory.NO_FACTORY;
    ...
    public TestParameterValue(final TestApiParameter apiParameter, final TestParameterFactory valueFactory) {
        this(UUID.randomUUID().toString(), apiParameter.getId(), valueFactory, "");
    }
    ...
    public boolean equals(final Object obj) {
        ...
        return Objects.equals(simpleValue, other.simpleValue) && complexTypeValues.equals(other.complexTypeValues)
                && apiParameterId.equals(other.apiParameterId);
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(simpleValue) + complexTypeValues.hashCode() * 13 + apiParameterId.hashCode() * 29;
    }
    ...
    public TestParameterValue derivate(@Nullable final TestParameterFactory newFactory) {
