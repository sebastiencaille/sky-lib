...
public class WebRestControllersConfig {
	...
	@Bean
	public DictionariesController dictionariesController(ContextService contextService, DictionaryDao dictionaryDao) {
		return new DictionariesController(contextService, dictionaryDao);
	}
