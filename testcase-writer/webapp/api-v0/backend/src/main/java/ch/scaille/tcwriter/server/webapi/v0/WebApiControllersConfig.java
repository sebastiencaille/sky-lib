...
public class WebApiControllersConfig {
    ...
    @Bean
    ContextController contextControllerV0(SessionManager sessionAccessor,
    ...
    @Bean
    TestCaseController testCaseControllerV0(SessionManager sessionAccessor,
                                            TestCaseFacade testCaseFacade,
                                            DictionaryFacade dictionaryFacade,
                                            NativeWebRequest nativeWebRequest,
                                            WebFeedbackFacade webFeedbackFacade) {
        return new TestCaseController(sessionAccessor, testCaseFacade, webFeedbackFacade, nativeWebRequest, dictionaryFacade);
    }
